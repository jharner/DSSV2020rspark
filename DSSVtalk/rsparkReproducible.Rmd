...
* Repeatable: same data, same code, same user $\leadsto$ same result
* Reproducible: same data, same code, different user $\leadsto$ same result 
* Strong Reproducilbility: same data, different code, different user $\leadsto$ comparable result
* Replicable: different data, different code, different user $\leadsto$ comparable result
* Generalizable: different data, same code, same or different user $\leadsto$ comparable result
