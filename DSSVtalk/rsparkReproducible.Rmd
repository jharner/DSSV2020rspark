...
* Repeatable: same data, same code, same user 
* Reproducible: same data, same code, different user 
* Strong Reproducilbility: same data, different code, different user 
* Replicable: different data, different code, different user 
* Generalizable: different data, same code, same or different user 
